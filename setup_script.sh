...
sudo pacman -S --needed --noconfirm wget git alacritty zsh fzf thefuck

yay -S --needed --noconfirm visual-studio-code-bin brave-bin protonvpn-cli-ng mint-themes bibata-cursor-theme ruby-colorls
